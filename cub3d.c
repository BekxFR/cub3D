...
/*   Updated: 2023/01/18 18:15:53 by chillion         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_draw_pix_line_circle(t_v *v, int y, int x)
{
	...
	if (right > 360)
		right = right - 360;
	ft_draw_pix_line_dir(v, y, x, degree);
	ft_draw_pix_line_angle_right(v, y, x, right);
	ft_draw_pix_line_angle_left(v, y, x, left);
}
